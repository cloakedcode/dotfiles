...
pianobar_next = pianobar_cmd .. "next"
pianobar_like = pianobar_cmd .. "love"
pianobar_ban = pianobar_cmd .. "hate"
pianobar_tired = pianobar_cmd .. "tired"
pianobar_history = pianobar_cmd .. "history"
pianobar_upcoming = pianobar_cmd .. "upcoming"
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "'",
        ...
        scratch.drop("urxvt -name pianobar -e 'screen -x pianobar'",
